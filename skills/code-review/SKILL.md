...
## Conventions (adapt to your eslint config)
...
- **CSS custom properties**: Must follow your project naming convention
...
- Stylelint enforced via your shared stylelint config

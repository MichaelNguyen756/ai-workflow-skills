...
1. **Release title:** `<Capitalised Spaced Repo Name> <version>`
   - `my-server` → `My Server 7.6.0`
   - `my-widgets` → `My Widgets 4.2.0`
...
| WEB release URL | `customfield_20653` | `https://your-org.atlassian.net/projects/PROJ/versions/<ID>/tab/release-report-all-issues` |

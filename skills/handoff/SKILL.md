...
Save handoffs to `~/.kiro/handoffs/` with the format:
```
...
Save to `~/.kiro/handoffs/YYYY-MM-DD-<topic>.md` and display the path.
...
5. Save to the handoffs directory: `~/.kiro/handoffs/YYYY-MM-DD-<topic>.md`
